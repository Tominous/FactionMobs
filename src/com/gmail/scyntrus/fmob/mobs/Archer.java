...
public class Archer extends EntitySkeleton implements FactionMob {
    ...
    @Option(key = "Archer.powerCost", min = 0)
    ...
    public Archer(EntityTypes<? extends Entity> type, World world) {
    ...
    public void a(EntityLiving entityliving,
                  float f) { //TODO: Update name on version change (E: EntitySkeletonAbstract.attackEntityWithRangedAttack)
        if (damage > 0) {
